...
huggingface-cli download Qwen/Qwen2.5-VL-7B-Instruct --cache-dir ${HF_HOME}

echo "[2/2] Pre-downloading Faster-Whisper large-v3-turbo..."
huggingface-cli download Systran/faster-whisper-large-v3-turbo --cache-dir ${HF_HOME}
